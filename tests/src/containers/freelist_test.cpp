...
u8 FreelistShouldAllocateOneAndFreeOne() {
    ...
    u64 offset = INVALID_ID;  // Начните с неверного идентификатора, что является хорошим вариантом по умолчанию, поскольку такого никогда не должно произойти.
...
u8 FreelistShouldAllocateOneAndFreeMulti() {
    ...
    u64 offset2 = INVALID_ID;  // Начните с неверного идентификатора, что является хорошим вариантом по умолчанию, поскольку такого никогда не должно произойти.
    ...
    u64 offset3 = INVALID_ID;  // Начните с неверного идентификатора, что является хорошим вариантом по умолчанию, поскольку такого никогда не должно произойти.
    ...
    u64 offset4 = INVALID_ID;  // Начните с неверного идентификатора, что является хорошим вариантом по умолчанию, поскольку такого никогда не должно произойти.
