...
layout(location = 4) in vec4 in_tangent; // layout(location = 4) in vec3 in_tangent;
...
void main() {
	...
	out_dto.tangent = vec4(normalize(m3_model * in_tangent.xyz), in_tangent.w); // out_dto.tangent = normalize(m3_model * in_tangent);
