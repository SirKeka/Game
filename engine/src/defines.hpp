...
/// @brief Получает количество байтов из количества гибибайтов (GiB) (1024*1024*1024)
#define GIBIBYTES(amount) amount * 1024 * 1024 * 1024
/// @brief Получает количество байтов из количества мебибайтов (MiB) (1024*1024)
#define MEBIBYTES(amount) amount * 1024 * 1024
/// @brief Получает количество байтов из количества кибибайтов (KiB) (1024)
#define KIBIBYTES(amount) amount * 1024

/// @brief Получает количество байтов из количества гигабайт (GB) (1000*1000*1000)
#define GIGABYTES(amount) amount * 1000 * 1000 * 1000
/// @brief Получает количество байтов из количества мегабайт (MB) (1000*1000)
#define MEGABYTES(amount) amount * 1000 * 1000
/// @brief Получает количество байтов из количества килобайт (KB) (1000)
