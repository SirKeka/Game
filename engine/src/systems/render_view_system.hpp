...
public:
    ...
    static MINLINE RenderViewSystem* Instance() {
        return state;
    }
    ...
    bool Create(RenderView::Config& config);
    ...
    /// @return true в случае успеха; в противном случае false.
    bool BuildPacket(const RenderView* view, void* data, struct RenderView::Packet& OutPacket);
    ...
    /// @return true в случае успеха; в противном случае false.
    bool OnRender(const RenderView* view, const RenderView::Packet& packet, u64 FrameNumber, u64 RenderTargetIndex);
};
