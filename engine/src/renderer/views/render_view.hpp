...
protected:
    ...
    struct Renderpass** passes;     //Массив указателей на проходы рендеринга, используемые этим представлением.
...
public:
    ...
    virtual bool BuildPacket(void* data, Packet* OutPacket) = 0;
    ...
    /// @return true в случае успеха; в противном случае false.
    virtual bool Render(const Packet* packet, u64 FrameNumber, u64 RenderTargetIndex) = 0;
